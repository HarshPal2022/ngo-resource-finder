...
def split_purpose_mission(purpose, mission):
    """
    Split merged Purpose and Mission field.
    """
...
def clean_phone(phone):
    """
    Standardize phone/mobile numbers.
    Keeps multiple numbers separated by commas.
    """
